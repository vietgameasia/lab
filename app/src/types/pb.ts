...
export type BenchmarkResponse<Texpand = unknown> = Required<BenchmarkRecord> & BaseSystemFields<Texpand>
export type BrandResponse<Texpand = unknown> = Required<BrandRecord> & BaseSystemFields<Texpand>
export type ChipsetResponse<Texpand = unknown> = Required<ChipsetRecord> & BaseSystemFields<Texpand>
export type CpuResponse<Texpand = unknown> = Required<CpuRecord> & BaseSystemFields<Texpand>
export type EnvironmentResponse<Texpand = unknown> = Required<EnvironmentRecord> & BaseSystemFields<Texpand>
export type GpuResponse<Texpand = unknown> = Required<GpuRecord> & BaseSystemFields<Texpand>
export type GpuVariantsResponse<Texpand = unknown> = Required<GpuVariantsRecord> & BaseSystemFields<Texpand>
export type MainboardResponse<Texpand = unknown> = Required<MainboardRecord> & BaseSystemFields<Texpand>
export type ProgramResponse<Texpand = unknown> = Required<ProgramRecord> & BaseSystemFields<Texpand>
export type RamCapacityResponse<Texpand = unknown> = Required<RamCapacityRecord> & BaseSystemFields<Texpand>
export type ResolutionResponse<Texpand = unknown> = Required<ResolutionRecord> & BaseSystemFields<Texpand>
